...
#else
void  scm_free(void* alloc, void* mem);
void* scm_alloc(void* alloc, size_t size);
void* scm_calloc(void* alloc, size_t count, size_t size);
#define sexp_free scm_free
#define sexp_malloc scm_alloc
#define sexp_calloc scm_calloc
#endif
...
#endif
#define sexp_context_alloc(x)    (sexp_field(x, context, SEXP_CONTEXT, alloc))
...
SEXP_API sexp sexp_make_context(void* alloc, sexp ctx, size_t size, size_t max_size);
...
SEXP_API sexp_heap sexp_make_heap (void* alloc, size_t size, size_t max_size, size_t chunk_size);
...
#else
SEXP_API void sexp_free_heap (void* alloc, sexp_heap heap);
