...
s32 main(s32 argc, const s8** argv) {
...

    {
        ...
        settings.product_name  = string::interned::fold(VM_PRODUCT_NAME);
        settings.build_type    = string::interned::fold(VM_BUILD_TYPE);
        settings.version.major = VM_VERSION_MAJOR;
        settings.version.minor = VM_VERSION_MINOR;
