...
namespace basecode::cxx {
    ...
    namespace scope {
        namespace expr {
            namespace unary {
                ...
                string::slice_t name(unary_op_type_t type);

                u32 addrof_label(scope_t& scope, u32 expr_id);

                string::slice_t position_name(position_type_t type);
            ...
            namespace init {
                ...
                string::slice_t name(initializer_type_t type);

                u32 list(scope_t& scope, u32 expr_ids[], u32 size);
            }

            namespace assign {
                string::slice_t name(assignment_type_t type);
            ...
            namespace binary {
                string::slice_t name(binary_op_type_t type);
            ...
            string::slice_t name(expression_type_t type);

            u32 raw(scope_t& scope, string::slice_t source);

            u32 ident(scope_t& scope, string::slice_t name);
        ...
        namespace type {
            ...
            string::slice_t meta_name(meta_type_t type);

            u32 bit_mask(scope_t& scope, u32 type_id, u8 bits);

            u32 array(scope_t& scope, u32 type_id, u32 size = 0);

            string::slice_t aggregate_name(aggregate_type_t type);

            string::slice_t integral_size_name(integral_size_t size);
        ...
        namespace lit {
            ...
            u32 str(scope_t& scope, string::slice_t value);
        ...
        namespace stmt {
            namespace pp {
                string::slice_t name(preprocessor_type_t type);

                u32 pragma(scope_t& scope, string::slice_t expr);

                u32 include_local(scope_t& scope, string::slice_t path);

                u32 include_system(scope_t& scope, string::slice_t path);
            }

            namespace comment {
                u32 line(scope_t& scope, string::slice_t value);

                u32 block(scope_t& scope, string::slice_t value);
            }
            ...
            string::slice_t name(statement_type_t type);
    ...
    namespace program {
        ...
        string::slice_t revision_name(revision_t rev);
