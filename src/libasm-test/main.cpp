...
s32 main(s32 argc, const s8** argv) {
...

    {
        ...
        settings.product_name  = string::interned::fold(ASM_PRODUCT_NAME);
        settings.build_type    = string::interned::fold(ASM_BUILD_TYPE);
        settings.version.major = ASM_VERSION_MAJOR;
        settings.version.minor = ASM_VERSION_MINOR;
